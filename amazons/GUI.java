...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Game->New", this::setNew);
        addMenuButton("Settings->Manual White", this::setManualWhite);
        addMenuButton("Settings->Manual Black", this::setManualBlack);
        addMenuButton("Settings->Auto White", this::setAutoWhite);
        addMenuButton("Settings->Auto Black", this::setAutoBlack);
    ...
    /** manual white . */
    /**@param x */
    private void setManualWhite(String x) {
        _pendingCommands.offer("manual white");
    }
    /** Manual Black. */
    /**@param x */
    private void setManualBlack(String x) {
        _pendingCommands.offer("manual black");
    }
    /** Auto White. */
    /**@param x */
    private void setAutoWhite(String x) {
        _pendingCommands.offer("auto white");
    }
    /** Auto Black. */
    /**@param x */
    private void setAutoBlack(String x) {
